...
then
  BUILD_TYPE=RELEASE
  BUILD_SUFFIX=opt
  BUILD_C_FLAGS=" -xCORE-AVX2"
  BUILD_CXX_FLAGS=" -xCORE-AVX2"
  BUILD_F_FLAGS=" -xCORE-AVX2"
  BUILD_LINK_FLAGS=""
  BOUNDS_CHECKING=OFF
elif [[ "${VARIANT:?}" == "dbg" ]]
then
...
cmake \
   ...
   -D BLAS_LIBRARY_DIRS:PATH="${BLAS_DIR}/mkl/lib/intel64;${BLAS_DIR}/lib/intel64;${COMPILER_DIR}/lib/intel64" \
   -D BLAS_LIBRARY_NAMES:STRING="mkl_intel_lp64;mkl_intel_thread;mkl_core;iomp5" \
   \
   -D TPL_ENABLE_LAPACK=ON \
   -D LAPACK_LIBRARY_DIRS:PATH="${LAPACK_DIR}/mkl/lib/intel64;${LAPACK_DIR}/lib/intel64;${COMPILER_DIR}/lib/intel64" \
