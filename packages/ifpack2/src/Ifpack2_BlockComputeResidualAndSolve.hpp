...
namespace Ifpack2::BlockHelperDetails {
  ...
  public:
    ...
    void run(
      ...
      IFPACK2_BLOCKHELPER_TIMER_WITH_FENCE("BlockTriDi::ComputeResidualAndSolve::RunSinglePass", ComputeResidualAndSolve0, execution_space);
  ...
  public:
    ...
    void run_pass1(
         ...
         const Unmanaged<impl_scalar_type_2d_view_tpetra>& y_) {
      IFPACK2_BLOCKHELPER_PROFILER_REGION_BEGIN;
      IFPACK2_BLOCKHELPER_TIMER_WITH_FENCE("BlockTriDi::ComputeResidualAndSolve::RunPass1", ComputeResidualAndSolve0, execution_space);
    ...
    magnitude_type run_pass2(
         const ConstUnmanaged<impl_scalar_type_2d_view_tpetra>& x_,
         const ConstUnmanaged<impl_scalar_type_2d_view_tpetra>& x_remote_,
         const Unmanaged<impl_scalar_type_2d_view_tpetra>& y_) {
      IFPACK2_BLOCKHELPER_PROFILER_REGION_BEGIN;
      IFPACK2_BLOCKHELPER_TIMER_WITH_FENCE("BlockTriDi::ComputeResidualAndSolve::RunPass2", ComputeResidualAndSolve0, execution_space);

      x = x_; x_remote = x_remote_; y = y_;
  ...
  public:
    ...
    void run(
         ...
         const Unmanaged<impl_scalar_type_2d_view_tpetra>& y_) {
      IFPACK2_BLOCKHELPER_PROFILER_REGION_BEGIN;
      IFPACK2_BLOCKHELPER_TIMER_WITH_FENCE("BlockTriDi::ComputeResidualAndSolve::Run_Y_Zero", ComputeResidualAndSolve0, execution_space);
